...
const Tickboxgrid = () => {
  return (
    <div className='w-[55%] m-2 p-7 rounded-xl bg-white'>
      <p className='text-[16px]'>Tick Box Grid <span className='text-red-500'>*</span></p>
      <div className='mt-4 text-[15px]'>
        ...
        <div className='mb-1 bg-slate-200 rounded-sm h-12 p-3'>
          <ul className='flex flex-row justify-center items-center'>
            ...
            <li className='w-[23%] pl-5'><input type='checkbox' name='val1' /></li>
            <li className='w-[23%] pl-5'><input type='checkbox' name='val1' /></li>
            <li className='w-[23%] pl-5'><input type='checkbox' name='val1' /></li>
          </ul>
        </div>
        <div className='mb-1 bg-slate-200 rounded-sm h-12 p-3'>
          <ul className='flex flex-row justify-center items-center'>
            ...
            <li className='w-[23%] pl-5'><input type='checkbox' name='val2' /></li>
            <li className='w-[23%] pl-5'><input type='checkbox' name='val2' /></li>
            <li className='w-[23%] pl-5'><input type='checkbox' name='val2' /></li>
          </ul>
        </div>
        <div className='mb-1 bg-slate-200 rounded-sm h-12 p-3'>
          <ul className='flex flex-row justify-center items-center'>
            ...
            <li className='w-[23%] pl-5'><input type='checkbox' name='val3' /></li>
            <li className='w-[23%] pl-5'><input type='checkbox' name='val3' /></li>
            <li className='w-[23%] pl-5'><input type='checkbox' name='val3' /></li>
          </ul>
        </div>
